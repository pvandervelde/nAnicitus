...
namespace Nanicitus.Core.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Loading of package failed. Error was: {0}..
        /// </summary>
        internal static string Log_Messages_SymbolIndexer_PackageLoadingFailed_WithException {
            get {
                return ResourceManager.GetString("Log_Messages_SymbolIndexer_PackageLoadingFailed_WithException", resourceCulture);
            }
        }
